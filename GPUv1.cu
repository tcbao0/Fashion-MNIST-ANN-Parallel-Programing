...
int main(int argc, char *argv[])
{
    ...
    printf("---------Training with optimized GPU 1---------\n");
    result = trainKernel2(trainImages, trainLabels, testImages, testLabels, numTrainImages, numtestImages, numRows, numCols, epochs);
